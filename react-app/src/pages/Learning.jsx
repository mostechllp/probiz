...
const Learning = () => {
    ...
    const handleGuideSubmit = (e) => {
        ...
        emailjs.send(
            'service_cx2f9pn',    // Replace with your EmailJS service ID
            'template_6osym1i',   // Replace with your EmailJS template ID
            templateParams,
            'DQ1wJtmHySoJsofYP'     // Replace with your EmailJS public key
        ).then((response) => {
